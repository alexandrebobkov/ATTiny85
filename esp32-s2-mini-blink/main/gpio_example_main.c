/*  GPIO Example
    ...
    ESP32 S2 mini board
    Project ESP-IDF board: ESP32-S2 chip (via ESP USB bridge)
...
#define GPIO_OUTPUT_IO_0    CONFIG_GPIO_OUTPUT_0    // Use 16 (physical) for ESP32 S2 mini
#define GPIO_OUTPUT_IO_1    CONFIG_GPIO_OUTPUT_1    // Use 21 (physical) for built-in blue LED
