...
#else
static gpio_num_t i2c_gpio_sda = 13;     // Physical pin; Logical 8; Default 18
static gpio_num_t i2c_gpio_scl = 14;     // Physical pin; Logical 9; Default 19
#endif
...
// I2C Master init; master device sets clock of a bus
